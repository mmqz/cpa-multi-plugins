...
//  3. POST GetLoginGuidance with multi-endpoint fallback (cockpit-tools
//     request_login_guidance): api.trae.cn → api.trae.com.cn → www.trae.cn;
//     CN degrades to the default login host on total failure.
