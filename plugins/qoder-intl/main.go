// Package main implements the qoder-intl CLIProxyAPI dynamic plugin.
//
// qoder-intl wraps Qoder Intl (qoder.com / api3.qoder.sh) OpenAPI as a cliproxy
...
// qoderwork.so binary (based on Sliverkiss/cpa-plugin/qoderwork). Adapted for intl.
//
...
const (
	providerName  = "qoder-intl"
	authFileName  = "qoder-intl.json"
	...
	upstreamBaseCN = "https://openapi.qoder.sh"
	gatewayBaseCN  = "https://api3.qoder.sh"
...
func wbRegistration() registration {
	return registration{
		...
		Metadata: pluginapi.Metadata{
			Name:             providerName,
			Version:          version,
			Author:           "mmqz (based on qoderwork by Sliverkiss/lovingfish)",
