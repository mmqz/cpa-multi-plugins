...
// Mirror of the qoder note-preservation absorption (bfSan 68acf6f/ba7192b
// failure mode, re-verified against our tree): a cr==nil round (restart, lazy
// refresh, transient billing error) used to regress a known "余N 已用N" note
// back to "积分未知".
